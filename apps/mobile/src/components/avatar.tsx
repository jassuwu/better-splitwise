...
/** A round avatar — shows the Splitwise profile photo when available, else the name initial. */
  ...
  return (
    <View
      ...
      {uri ? (
        ...
        <Text className="text-white font-semibold" style={{ fontSize: Math.round(size * 0.4) }}>
          {initial}
        </Text>
      )}
    </View>
